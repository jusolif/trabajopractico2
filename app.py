...
if modulo == "Home":
  ...
  st.write("2026")
  st.write("Este proyecto está baasado en el archivo BankMarketing.csv, correspondiente a una institución financiera que buscan entender los factores que influyen en la aceptación de sus campañas de marketing")
